package com.f1.utils
{
    ...
    final public class KeyCode extends Object
    {
        ...
        public static function isChar(param1:int) : Boolean
        {
            if (!(param1 >= A && param1 <= Z || param1 >= NUMBER_0 && param1 <= NUMBER_9 || param1 >= NUMPAD_0 && param1 <= NUMPAD_9))
            {
            }
            return param1 == SPACE;
        }// end function

        public static function codeIsChar(param1:int) : Boolean
        {
            if (!(param1 > 47 && param1 < 58 || param1 > 64 && param1 < 91 || param1 > 96 && param1 < 123))
            {
            }
            return param1 == 32;
        }// end function
