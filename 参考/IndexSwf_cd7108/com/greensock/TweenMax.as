    ...
    public class TweenMax extends TweenLite implements IEventDispatcher
    {
        ...
        public function updateTo(param1:Object, param2:Boolean = false) : void
        {
            ...
            for (_loc_4 in param1)
            {
                ...
                this.vars[_loc_4] = _loc_9[_loc_4];
            }
            if (this.initted)
            {
                this.initted = false;
        ...
        override public function renderTime(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
        {
            ...
            if (this._repeat != 0)
            {
                ...
                else if (param1 > 0)
                {
                    ...
                    this._cyclesComplete = this.cachedTotalTime / _loc_10 >> 0;
            ...
            if (_loc_5 == 0 && (this.cachedTotalTime != 0 || this.cachedDuration == 0) && !param2)
            {
