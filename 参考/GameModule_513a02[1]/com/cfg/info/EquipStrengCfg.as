package com.cfg.info
{
    ...
    public class EquipStrengCfg extends Object
    {
        public var q_level:String;
        public var q_item_id:int;
        public var q_id:String;
        public var q_item_name:String;
        ...
        public function EquipStrengCfg()
        {
            return;
        }// end function
        ...
        public function parse(param1:Object) : void
        {
            ...
            var _loc_3:* = String(this.q_element_defence).split(";");
            var _loc_4:* = 0;
            ...
            _loc_3 = String(this.q_element_attack).split(";");
            _loc_4 = 0;
            while (_loc_4 < _loc_3.length)
            {
