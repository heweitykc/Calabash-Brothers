package com.view.fightbase.view
{
    import com.f1.*;
    import com.f1.utils.*;
    ...
    public class FarAtkLight extends BaseSprite
    {
        private var _arrow:DisplayObject;
        public var flyTime:Number = 0;
        private var currentSkillInfo:SkillInfo;

        public function FarAtkLight(param1:SkillInfo)
        {
        ...
        public function flyByAngle(param1:Number, param2:uint, param3:Boolean = false, param4:Function = null, param5:Array = null) : void
        {
            ...
            if (this._arrow)
            {
                if (this.currentSkillInfo.q_rotation == 1)
                {
