package com.f1.view.mapeditor
{
    ...
    public class BgView extends BaseSprite
    {
        ...
        public function update(param1:String, param2:Function, param3:Function = null) : void
        {
            ...
            VResManager.load(param1, this.loadBinComplete, [param2], null, null, false, true);
            return;
        }// end function
        ...
        protected function loadBinComplete(param1:ByteArray, param2:Function) : Object
        {
            ...
            this._roofs = _loc_4.roof as Array;
        ...
        {
            this._smallBg = new Bitmap(param1);
            var _loc_2:* = 16;
            this._smallBg.scaleY = 16;
            this._smallBg.scaleX = _loc_2;
        ...
        protected function addBgFragments() : void
        {
            ...
            while (_loc_6 < this.fragmentH)
            {
                ...
                while (_loc_7 < this.fragmentW)
                {
                    ...
                    _loc_5 = this.bgSrc + "/bgfm" + _loc_4 + ".jpg";
                    _loc_1.push(_loc_5);
            ...
            VResManager.loadGroup(_loc_1, this.addOneFragmentComplete, _loc_2, this.addOneFragmentFail, null, this.addFragmentsComplete);
            return;
        }// end function
        ...
        protected function addOneFragmentComplete(param1:BitmapData, param2:int, param3:int, param4:int) : void
        {
        ...
        protected function showFragment(param1:BitmapData, param2:int, param3:int, param4:int) : void
        {
            var _loc_5:* = new Bitmap(param1);
            _loc_5.x = param3 * this.fragmentWidth;
            _loc_5.y = param4 * this.fragmentHeight;
            if (_loc_5.width != this.fragmentWidth)
            {
                _loc_5.width = this.fragmentWidth;
            }
            if (_loc_5.height != this.fragmentHeight)
            {
                _loc_5.height = this.fragmentHeight;
            }
            addChild(_loc_5);
            return;
        }// end function
        ...
        protected function addFragmentsComplete() : void
        {
            if (this._smallBg)
            {
                if (this._smallBg.bitmapData)
                {
                    this._smallBg.bitmapData.dispose();
                }
                if (this._smallBg.parent == this)
                {
                    removeChild(this._smallBg);
                }
                this._smallBg = null;
            }
            return;
