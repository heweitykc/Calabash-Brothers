package com.game.player.view
{
    ...
    public class SelectBossBox extends Component
    {
        ...
        public function SelectBossBox()
        {
            loadDisplay("res/selectbossbox.swf");
            return;
        }// end function

        override protected function displayReady() : void
        {
            initComponentUI("selectBossBox");
            this.initUI();
            super.displayReady();
            return;
        }// end function
        ...
        private function initUI() : void
        {
            ...
            this._buffContainer.move(130, 120);
        ...
        public function setName(param1:String) : void
        {
            ...
            {
                _loc_3 = param1.split(LanguageCfgObj.getInstance().getByIndex("11024"));
                this._nameTxt.htmlText = _loc_3.pop();
            }
            return;
        }// end function
