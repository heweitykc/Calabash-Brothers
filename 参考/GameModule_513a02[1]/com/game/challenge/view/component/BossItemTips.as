package com.game.challenge.view.component
{
    ...
    public class BossItemTips extends BaseTips
    {
        ...
        {
            this._content = ToolKit.getNew("bossGuide_bossTips") as MovieClip;
        ...
        override public function repaint(param1:Object) : void
        {
            ...
            _loc_3 = MonsterCfgObj.getInstance().getMonsterCfg(_loc_2.q_monsterid);
