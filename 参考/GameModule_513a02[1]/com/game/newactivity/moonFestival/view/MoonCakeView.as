package com.game.newactivity.moonFestival.view
{
    ...
    public class MoonCakeView extends Component implements IMoonFestivalView
    {
        ...
        private static const COUNT_STEP1:int = 10000;
        private static const COUNT_STEP2:int = 20000;
        private static const COUNT_STEP3:int = 35000;

        public function MoonCakeView(param1 = null, param2:String = null)
        {
        ...
        {
            this._info = NewActivityModel.getInstance().getActivityByActivityId(NewActivityConfig.ACTID_MOONFESTIVAL_3);
            ...
            this.wordTipsBox1 = StringUtil.languageReplace(LanguageCfgObj.getInstance().getByIndex("12462"), [COUNT_STEP1]);
            this.wordTipsBox2 = StringUtil.languageReplace(LanguageCfgObj.getInstance().getByIndex("12463"), [COUNT_STEP2]);
            this.wordTipsBox3 = StringUtil.languageReplace(LanguageCfgObj.getInstance().getByIndex("12464"), [COUNT_STEP3]);
        ...
        public function setPainInfo(param1:int, param2:Vector.<ItemInfo>) : void
        {
            ...
            if (param1 >= COUNT_STEP1)
            {
                ...
                this.wordTipsBox1 = LanguageCfgObj.getInstance().getByIndex("12465");
            ...
            if (param1 >= COUNT_STEP2)
            {
                ...
                this.wordTipsBox2 = LanguageCfgObj.getInstance().getByIndex("12465");
            ...
            if (param1 >= COUNT_STEP3)
            {
                ...
                this.wordTipsBox3 = LanguageCfgObj.getInstance().getByIndex("12465");
