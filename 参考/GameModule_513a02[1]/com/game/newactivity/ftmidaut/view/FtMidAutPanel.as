package com.game.newactivity.ftmidaut.view
{
    import __AS3__.vec.*;
    import com.events.*;
    import com.f1.*;
    ...
    public class FtMidAutPanel extends BaseBox
    {
        ...
        public function FtMidAutPanel(param1 = null, param2:uint = 60, param3:String = "", param4:Boolean = true)
        {
            super(param1, param2, param3, param4);
            loadDisplay("res/ftmidaut.swf");
            return;
        }// end function
        ...
        {
            this._info = NewActivityModel.getInstance().getActivityByActivityId(NewActivityConfig.ACTID_MID_AUTUMN);
            ...
            this.wordTipsBox1 = StringUtil.languageReplace(LanguageCfgObj.getInstance().getByIndex("10000", "lang_ftmidaut"), [COUNT_STEP1]);
            this.wordTipsBox2 = StringUtil.languageReplace(LanguageCfgObj.getInstance().getByIndex("10001", "lang_ftmidaut"), [COUNT_STEP2]);
            this.wordTipsBox3 = StringUtil.languageReplace(LanguageCfgObj.getInstance().getByIndex("10002", "lang_ftmidaut"), [COUNT_STEP3]);
        ...
        public function setPainInfo(param1:int, param2:Vector.<ItemInfo>) : void
        {
            ...
            if (param1 >= COUNT_STEP1)
            {
                ...
                this.wordTipsBox1 = LanguageCfgObj.getInstance().getByIndex("10003", "lang_ftmidaut");
            ...
            if (param1 >= COUNT_STEP2)
            {
                ...
                this.wordTipsBox2 = LanguageCfgObj.getInstance().getByIndex("10004", "lang_ftmidaut");
            ...
            if (param1 >= COUNT_STEP3)
            {
                ...
                this.wordTipsBox3 = LanguageCfgObj.getInstance().getByIndex("10005", "lang_ftmidaut");
