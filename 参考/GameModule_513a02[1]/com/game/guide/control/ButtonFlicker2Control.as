package com.game.guide.control
{
    ...
    public class ButtonFlicker2Control extends Object
    {
        ...
        private static var _instance:ButtonFlicker2Control;

        public function ButtonFlicker2Control()
        {
            this.targetList = [];
            this.filter = new GlowFilter(16762368, 1, 0, 0, 0, BitmapFilterQuality.LOW, false, false);
            this.innerFilter = new GlowFilter(16762368, 1, 0, 0, 0, BitmapFilterQuality.LOW, true, false);
            return;
        }// end function
        ...
        public static function getInstance() : ButtonFlicker2Control
        {
            var _loc_1:* = new ButtonFlicker2Control;
            _instance = new ButtonFlicker2Control;
