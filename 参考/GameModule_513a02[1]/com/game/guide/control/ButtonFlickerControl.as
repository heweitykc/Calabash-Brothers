package com.game.guide.control
{
    ...
    public class ButtonFlickerControl extends Object
    {
        ...
        private static var _instance:ButtonFlickerControl;

        public function ButtonFlickerControl()
        {
            this.targetList = [];
            this.filter = new GlowFilter(16763904, 1, 0, 0, 0, BitmapFilterQuality.LOW, false, false);
            this.innerFilter = new GlowFilter(16763904, 1, 0, 0, 0, BitmapFilterQuality.LOW, true, false);
            return;
        }// end function
        ...
        private function enterFrame(event:Event) : void
        {
            ...
            if (this.updateTime == 3)
            {
                ...
                this.innerFilter.blurX = this.innerFilter.blurX + 1 * this.note * 1.2;
                this.innerFilter.blurY = this.innerFilter.blurY + 1 * this.note * 1.2;
        ...
        public static function getInstance() : ButtonFlickerControl
        {
            var _loc_1:* = new ButtonFlickerControl;
            _instance = new ButtonFlickerControl;
