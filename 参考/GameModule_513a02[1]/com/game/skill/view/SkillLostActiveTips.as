package com.game.skill.view
{
    ...
    public class SkillLostActiveTips extends BaseTips
    {
        ...
        public function SkillLostActiveTips()
        {
            this.initComp();
            return;
        }// end function
        ...
        override public function repaint(param1:Object) : void
        {
            ...
            var _loc_3:* = LanguageCfgObj.getInstance().getByIndex("11164");
            var _loc_4:* = _loc_3.replace("^_^", _loc_2.q_skill_name);
            this.drawSkillName(_loc_4);
            var _loc_5:* = LanguageCfgObj.getInstance().getByIndex("11165");
            this.drawSkillNeedLabel(_loc_5);
            var _loc_6:* = this.getNeedStr(_loc_2);
            _loc_6 = "<TextFormat leading = \'3\'>" + _loc_6 + "</TextFormat>";
            this.drawSkillNeedInfo(_loc_6);
            this.drawLine1();
            var _loc_7:* = LanguageCfgObj.getInstance().getByIndex("11166");
            var _loc_8:* = "Lv." + _loc_2.q_skill_level + "/" + _loc_2.q_skill_levelmax;
            _loc_8 = _loc_7.replace("^_^", _loc_8);
            this.drawActLevel(_loc_8);
            var _loc_9:* = _loc_2.q_info;
            this.drawActEffect(_loc_9);
            this.drawBack();
            this._ruleX = 17;
            this._ruleY = 16;
            return;
