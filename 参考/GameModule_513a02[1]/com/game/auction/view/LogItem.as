package com.game.auction.view
{
    ...
    public class LogItem extends Component implements IItem
    {
        ...
        private function update() : void
        {
            ...
            {
                _loc_1 = "【" + LanguageCfgObj.getInstance().getByIndex("11891") + "】" + ToolKit.getFormatDate(this._info.transactiontime * 1000, "ymdhms") + StringUtil.languageReplace(LanguageCfgObj.getInstance().getByIndex("11892"), ["【<u><font color = \'#ffde00\'><a href=\'event:user|" + this._info.tradersname + "|" + this._info.tradersid + "\'>" + this._info.tradersname + "</a></font></u>】", ToolKit.getMoneyString(this._info.iteminfo.num.toNumber()), "<font color = \'#ffffff\'>" + ToolKit.getMoneyString(this._info.priceyuanbao) + "</font><br>", "<font color = \'#ffffff\'>" + this._info.pricegold + "</font>"]);
            }
            else if (this._info.transactiontype == 1)
            {
                _loc_1 = "【" + LanguageCfgObj.getInstance().getByIndex("11891") + "】" + ToolKit.getFormatDate(this._info.transactiontime * 1000, "ymdhms") + StringUtil.languageReplace(LanguageCfgObj.getInstance().getByIndex("11893"), ["【<u><font color = \'#ffde00\'><a href=\'event:user|" + this._info.tradersname + "|" + this._info.tradersid + "\'>" + this._info.tradersname + "</a></font></u>】", ToolKit.getMoneyString(this._info.iteminfo.num.toNumber()), "<font color = \'#ffffff\'>" + ToolKit.getMoneyString(this._info.priceyuanbao) + "</font>"]);
            }
