package com.game.protect.view
{
    ...
    public class ProtectUnlockPanel extends ProtectBaseBox
    {
        ...
        public function ProtectUnlockPanel()
        {
        ...
        {
            initBaseBoxUI("protectUnlockPanel");
            this.initUI();
            super.displayReady();
            return;
        }// end function
        ...
        public function initUI() : void
        {
            ...
            this.btnOk.setText(LanguageCfgObj.getInstance().getByIndex("11108"), true);
            this.btnCancel = ProtectUiUtil.createButton(this, "btnCancel", this.onClose);
            this.btnCancel.setText(LanguageCfgObj.getInstance().getByIndex("11109"), true);
        ...
        private function onOk(event:MouseEvent) : void
        {
            ...
            if (_loc_2.length == 0)
            {
                Global.popManager.addedToMouseCue(LanguageCfgObj.getInstance().getByIndex("11110"));
                return;
            }
            ProtectControl.getInstance().unlock(_loc_2);
            return;
        }// end function
