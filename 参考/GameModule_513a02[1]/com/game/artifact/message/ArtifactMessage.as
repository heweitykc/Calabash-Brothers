package com.game.artifact.message
{
    ...
    public class ArtifactMessage extends Message
    {

        public function ArtifactMessage()
        {
            return;
        }// end function
        ...
        protected function readLongAsNumber() : Number
        {
            return readLong().toNumber();
        }// end function

        protected function readLongsAsNumbers() : Vector.<Number>
        {
            ...
            while (_loc_2 < _loc_1.length)
            {
                ...
                _loc_1[_loc_2] = readLong().toNumber();
                _loc_2++;
            }
            return _loc_1;
        }// end function
