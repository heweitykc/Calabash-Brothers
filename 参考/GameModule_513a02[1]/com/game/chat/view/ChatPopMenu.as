package com.game.chat.view
{
    ...
    public class ChatPopMenu extends BaseSprite
    {
        ...
        private static var _instance:ChatPopMenu;

        public function ChatPopMenu()
        {
            this._operItems = [{label:LanguageCfgObj.getInstance().getByIndex("11667"), data:"chat"}, {label:LanguageCfgObj.getInstance().getByIndex("11668"), data:"info"}, {label:LanguageCfgObj.getInstance().getByIndex("11669"), data:"team"}, {label:LanguageCfgObj.getInstance().getByIndex("11682"), data:"copyname"}];
        ...
        public function getPoints(param1:DisplayObject) : Point
        {
        ...
        public static function getInstance() : ChatPopMenu
        {
            var _loc_1:* = new ChatPopMenu;
            _instance = new ChatPopMenu;
