package com.game.zones.view.awards
{
    ...
    public class ZonesDefeatPanel extends BaseBox
    {
        private var _btnSure:BaseButton;
        private var _btnClose:BaseButton;

        public function ZonesDefeatPanel(param1 = null, param2:uint = 60, param3:String = "", param4:Boolean = true)
        {
            super(param1, param2, param3, param4);
            loadDisplay("res/zonesdefeat.swf");
            return;
        }// end function

        override protected function displayReady() : void
        {
            initBaseBoxUI("zones_defeat");
            this.initUI();
            this.addEvents();
            super.displayReady();
            return;
