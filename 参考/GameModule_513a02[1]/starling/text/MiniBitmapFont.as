package starling.text
{
    ...
    class MiniBitmapFont extends Object
    {
        ...
        {
            var _loc_1:* = new BitmapData(BITMAP_WIDTH, BITMAP_HEIGHT);
            var _loc_2:* = new ByteArray();
            var _loc_3:* = BITMAP_DATA.length;
            var _loc_4:* = 0;
            while (_loc_4 < _loc_3)
            {
                
                _loc_2.writeUnsignedInt(BITMAP_DATA[_loc_4]);
                _loc_4++;
            }
            _loc_2.uncompress();
            _loc_1.setPixels(new Rectangle(0, 0, BITMAP_WIDTH, BITMAP_HEIGHT), _loc_2);
            return Texture.fromBitmapData(_loc_1, false);
        }// end function
