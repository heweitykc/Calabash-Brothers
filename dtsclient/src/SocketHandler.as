package
{
    ...
    public class SocketHandler extends BaseEventDispatcher
    {
		...
		public static const LINK_STATUS_NOTINITIALIZED:uint = 0;
		public static const LINK_STATUS_NOTAVAILABLE:int = 1;
		public static const LINK_STATUS_NEEDTOCONNECT:uint = 2;
		public static const LINK_STATUS_CONNECTTING:uint = 3;
		public static const LINK_STATUS_CONNECTED:uint = 4;
        ...
        public function setAddr(appid:uint, svrip:String, svrport:int, svrsport:int = 0, linkmode:uint = 1) : void
        {
            this.svrIP = svrip;
            this.svrPort = svrport;
            this.svrSPort = svrsport;
            this.appID = appid;
