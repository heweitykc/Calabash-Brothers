...
bool GameLayer::init()
{
	...
	do 
	{
		...
		listener->onTouchesBegan = CC_CALLBACK_2(GameLayer::onTouchesBegin, this);
...
void GameLayer::initTileMap()
{
	...
	Vector<Node*> mapChildren = _tileMap->getChildren();
	for (auto pObject : mapChildren)	{
...
void GameLayer::onTouchesBegin(const std::vector<cocos2d::Touch*>& touches, cocos2d::Event* event)
{
	_hero->attack();
...
{		
	for (auto pObject : _actors->getChildren())
	{
